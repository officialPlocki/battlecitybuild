...
public class TphereCommand extends Language implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
    ...
    if (args.length == 1) {
      if (Bukkit.getPlayer(args[0]) != null) {
        ...
        player.sendMessage(prefix + "§a" + target.getName() + " §7wurde zu dir teleportiert!");
      } else {
        player.hasPermission(prefix+"Dieser Spieler ist nicht online.");
      } 
      return false;
    } 
    player.sendMessage(prefix + "Bitte benutze: §e/tphere <Spieler>");
    return false;
  }
}
